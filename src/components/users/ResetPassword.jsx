...
const ResetPassword = () => {
  ...
  useEffect(() => {
    ...
    if (tokenParam) {
      setToken(tokenParam);
      setLoading(false);
      const appLink = `spicedirectwholesale://reset-password?token=${tokenParam}`;
      const androidStore = "https://play.google.com/store/apps/details?id=com.spicedirectwholesale";
      const iosStore = "https://apps.apple.com/app/id876767566";
  ...
  const storeLink = isAndroid
    ? "https://play.google.com/store/apps/details?id=com.spicedirectwholesale"
    : "https://apps.apple.com/app/id876767566";
            ...
            <div className="text-center">
              ...
              <div className="mt-6 space-y-4">
                ...
                >
                  ...
                  {isAndroid ? "Download App from Play Store" : "Download from App Store"}
                </a>
