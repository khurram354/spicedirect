...
const SupplierImageList = ({slidersupplier, deleteSliderHandler}) => {
  return (
     <section>
                    <div className="w-3/4 px-4 mx-auto mt-6 relative left-24 top-5">
                        <table className="w-full overflow-x-auto">
                            ...
                            {slidersupplier && slidersupplier.map((slider, index) => {
                                        ...
                                        <td className="px-1 py-3 text-sm w-40 relative ">
                                            <div className="flex justify-center items-center space-x-2">
                                                <span className="relative w-20 h-20 overflow-hidden">
                                                    <Image
                                                        src={`${'/images/supplierslider'}/${slider.imageurl}`}
                                                        width={100}
                                                        height={100}
                                                        alt="Loading..."
...
export default SupplierImageList