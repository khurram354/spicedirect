        ...
        <div className="flex items-center justify-center sm:items-stretch md:justify-start">
          <div className="hidden sm:ml-6 md:block">
            <div className="flex justify-center items-center">
              ...
              {/* <Link href="/product?offers=special_offers" className="border-r-2 border-white-500 text-white font-medium bg-warningcolor text-sm h-[40px] flex justify-center items-center px-4 hover:bg-white hover:text-warningcolor transform transition duration-300">PROMOTIONS</Link> */}
              <Link href="/promotions" className="border-r-2 border-white-500 text-white font-medium bg-warningcolor text-sm h-[40px] flex justify-center items-center px-4 hover:bg-white hover:text-warningcolor transform transition duration-300">PROMOTIONS</Link>
